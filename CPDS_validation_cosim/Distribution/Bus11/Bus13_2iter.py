...
# DER_output= [0 for val in DER_output]

# active_power='secant'

# active_power='Pmin'
active_der = 4
DER_output=[850 for i in range(4)]
del_pp =1400
...
voltage_results.to_csv(dir_to_results+'\\voltage_results_'+str(del_pp)+'.csv')
results_time = {}
