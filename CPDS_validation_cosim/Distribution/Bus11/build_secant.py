...
i=2
for idx in range(15):
    val = voltage2_d1.iloc[4,i] - voltage0_ref.iloc[10,i]
    val=val/del_p
    A.append(val)
    i+=1
...
i=2
for idx in range(15):
    val = voltage2_d2.iloc[4,i] - voltage0_ref.iloc[10,i]
    val=val/del_p
    B.append(val)
    i+=1
...
i=2
for idx in range(15):
    val = voltage2_d3.iloc[4,i] - voltage0_ref.iloc[10,i]
    val=val/del_p
    C.append(val)
    i+=1
...
i=2
for idx in range(15):
    val = voltage2_d4.iloc[4,i] - voltage0_ref.iloc[10,i]
    val=val/del_p
    D.append(val)
    i+=1
...
for val in range(num_DER):
    DER_headroom_limit.append(((V_max - DER_bus_voltage[i]) / DER_sens_list[i] ))
    i+=1
...
voltage_results.to_csv(dir_to_results+'\\secant_results_'+str(del_power_demand)+'.csv')
